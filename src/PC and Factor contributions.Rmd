...
PC1contribution_df <- data.frame(contribution =  pca_data$var$contrib[,1], loadings = pca_data$var$coord[,1])[order(-pca_data$var$contrib[,1]),]
print(PC1contribution_df)
write.csv(PC1contribution_df, "PC1contribution.csv")

PC2contribution_df <- data.frame(contribution =  pca_data$var$contrib[,2], loadings = pca_data$var$coord[,2])[order(-pca_data$var$contrib[,2]),]
print(PC2contribution_df)
write.csv(PC2contribution_df, "PC2contribution.csv")
...
PC1contribution_df <- data.frame(contribution =  pca_data$var$contrib[,1], loadings = pca_data$var$coord[,1])[order(-pca_data$var$contrib[,1]),]
print(PC1contribution_df)
write.csv(PC1contribution_df, "PC1contribution6h.csv")

PC2contribution_df <- data.frame(contribution =  pca_data$var$contrib[,2], loadings = pca_data$var$coord[,2])[order(-pca_data$var$contrib[,2]),]
print(PC2contribution_df)
write.csv(PC2contribution_df, "PC2contribution6h.csv")
