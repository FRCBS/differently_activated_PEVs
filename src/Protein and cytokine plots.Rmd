...
plot_cytokines <- function(name){
  ...
  ggplot(aes(x= Sample, y = Intensity,  fill = Group))+ geom_bar(stat="identity") + theme_minimal()+ labs(title = name)+ theme(plot.title = element_text(hjust=0.5, size =20))+ theme(axis.title.x = element_text(size = 13, color = "black"), axis.title.y = element_text(size = 13, color = "black"), axis.text.x = element_blank(), axis.text.y = element_text(size = 11, color = "black"))
}
...
plot_proteins <- function(df_long, name){
  ...
  ggplot(aes(x= Sample, y = Abundance,  fill = Group))+ geom_bar(stat="identity") + theme_minimal()+theme(axis.text.x = element_blank())+ labs(title = name)+ theme(plot.title = element_text(hjust=0.5, size =15), axis.title.x = element_text(size = 13, color = "black"), axis.title.y = element_text(size = 13, color = "black"), axis.text.x = element_blank(), axis.text.y = element_text(size = 11, color = "black"))
...
boxplot_proteins <- function(df_long, name){
  df_long %>% filter(Protein == name) %>% 
  ggplot(aes(x= Group, y = Abundance,  fill = Group))+ geom_boxplot() + theme_minimal()+ labs(title = name)+ theme(plot.title = element_text(hjust=0.5, size =15),axis.title.x = element_text(size = 13, color = "black"), axis.title.y = element_text(size = 13, color = "black"), axis.text.x = element_blank(), axis.text.y = element_text(size = 11, color = "black"))
}
...
plot_cytokines <- function(df_long,name){
  ...
  ggplot(aes(x= group_time, y = Intensity,  fill = Group, pattern = Time))+ geom_boxplot_pattern(pattern_density = 0.1, pattern_fill = "black", pattern_spacing = 0.05) + facet_grid(~Group, scales = "free_x", space = "free_x") +theme_minimal()+ labs(title = name, x = "Sample", y = "Intensity")+ theme(plot.title = element_text(hjust=0.5, size =20),axis.title.x = element_text(size = 13, color = "black"), axis.title.y = element_text(size = 13, color = "black"), axis.text.x = element_blank(), axis.text.y = element_text(size = 11, color = "black"),strip.text = element_text(size = 11)) + scale_x_discrete(labels = rep(c("6h","24h"), times = 4))
}
