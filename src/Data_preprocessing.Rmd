...
colnames(raw_prot) <- c("protein", "unstimulated_PEV_1","unstimulated_PEV_2","unstimulated_PEV_3","GPVI_PEV_1", "GPVI_PEV_2", "GPVI_PEV_3", "CLEC2_PEV_1","CLEC2_PEV_2","CLEC2_PEV_3","TC_PEV_1","TC_PEV_2","TC_PEV_3")

raw_miRNA <- read.csv("/home/aosterberg/Documents/DI_työ/PEVmiRNA.csv",header = TRUE)
colnames(raw_miRNA) <- c("miRNA", "GPVI_PEV_1", "GPVI_PEV_2", "GPVI_PEV_3", "GPVI_PEV_4", "CLEC2_PEV_1","CLEC2_PEV_2","CLEC2_PEV_3", "CLEC2_PEV_4", "TC_PEV_1","TC_PEV_2","TC_PEV_3", "TC_PEV_4", "unstimulated_PEV_1","unstimulated_PEV_2","unstimulated_PEV_3","unstimulated_PEV_4", "Platelet_1", "Platelet_2", "Platelet_3", "Platelet_4")
...
raw_prot[,-1] %>% boxplot
raw_prot[,-1] %>% scale %>% boxplot
raw_miRNA[,-1] %>%  boxplot
raw_miRNA[,-1] %>% scale %>% boxplot


#We filter the 100 top features with most variance between samples 
raw_prot[,-1] %>%  apply(., 1, var) %>% hist
prot.var <- raw_prot[,-1] %>%  apply(., 1, var)
prot.var %>% sort %>% rev %>% .[100]
top_prot <- raw_prot[prot.var > 1.1676,] 


raw_miRNA[,-1] %>%  apply(., 1, var) %>% hist
...
boxplot(top_prot_norm)
boxplot(top_miRNA_norm_PEV)
...
empty_cols <- c("unstimulated_PEV_4", "GPVI_PEV_4", "CLEC2_PEV_4", "TC_PEV_4") #creating empty columns so that samples match as protein data have only 3 technical replicates 
...
write.csv(top_miRNA_norm_PEV, "top100PEVmiRNA_norm", row.names = TRUE)
write.csv(top_prot_norm_mat, "top100prot_norm", row.names = TRUE)
